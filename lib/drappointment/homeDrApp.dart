import 'package:loginpage/drappointment/utisl.dart';
                  ...
                  child:(
                      InkWell(
                        onTap:(){
                          ...
                          child: _iconBuilder(LineAwesomeIcons.check_circle, 'Accept ')))),
              Container(
                  child:(
                      InkWell(
                          onTap:(){
                          ...
                          child:_iconBuilder(LineAwesomeIcons.times_circle, 'Cancel')))),
